...
extern const MIDL_SERVER_INFO IPolyCtrl_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IPolyCtrl_ProxyInfo;
...
/* Object interface: IPolyCtrl, ver. 0.0,
   GUID={0xB471291B,0x3E1F,0x4CE9,{0xA4,0x82,0xD2,0x22,0x00,0x58,0x21,0xFB}} */

#pragma code_seg(".orpc")
static const unsigned short IPolyCtrl_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IPolyCtrl_ProxyInfo =
    ...
    &IPolyCtrl_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IPolyCtrl_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    Polygon__MIDL_ProcFormatString.Format,
...
static const PRPC_STUB_FUNCTION IPolyCtrl_table[] =
{
...
const ExtendedProxyFileInfo Polygon_ProxyFileInfo = 
{
