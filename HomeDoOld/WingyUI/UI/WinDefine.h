...
{
	extern const TCHAR* VolumeUp/* = "VolumeUp"*/;
	extern const TCHAR* VolumeDown/* = "VolumeDown"*/;
	extern const TCHAR* CloseScreen/* = "CloseScreen"*/;
	extern const TCHAR* KillProcess/* = "KillProcess"*/;
	extern const TCHAR* NotScreenSave/* = "NotScreenSave"*/;
}
...
public:
    ...
    static tstring GetValueFromConfig(const tstring& strAppName, const tstring& strKeyName, const tstring& strDefault, const tstring& strFileName);
    static int GetValueFromConfig(const tstring& strAppName, const string& strKeyName, int strDefault, const tstring& strFileName);
