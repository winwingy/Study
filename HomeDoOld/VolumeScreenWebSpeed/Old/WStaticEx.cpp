...
LRESULT CALLBACK WStaticEx::StaticExProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
{
    HWND hwnd = CreateWindow("EDIT", "hi", WS_CHILD|WS_VISIBLE, x,y, width, height, par, NULL, GetModuleHandle(NULL), this);
    assert(hwnd);
