// CreateCompatibleDC.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "CreateCompatibleDC.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_CREATECOMPATIBLEDC, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CREATECOMPATIBLEDC));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CREATECOMPATIBLEDC));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_CREATECOMPATIBLEDC);
