...
应用程序向导已为您创建了此 Test 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
Test.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CTestApp 应用程序类。
...
res\Test.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 Test.rc 中。
...
TestDlg.h、TestDlg.cpp - 对话框
    这些文件包含 CTestDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 Test.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
