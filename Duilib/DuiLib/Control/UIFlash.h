...
#import "PROGID:ShockwaveFlash.ShockwaveFlash"  raw_interfaces_only, named_guids,  rename("IDispatchEx","IMyDispatchEx")   /* fix conflicting with IDispatchEx ant dispex.h */  
